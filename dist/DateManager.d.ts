...
export declare type TDateAny = Date | number | string | null | undefined;
...
export declare const DateDiffLongDescription: (dateFrom: TDateAny, dateTo?: TDateAny, trimSeconds?: boolean) => string;
/**
...
export declare const DateCompare: (date1: TDateAny, evalType: 'IsSame' | 'IsBefore' | 'IsAfter' | 'IsSameOrBefore' | 'IsSameOrAfter', date2?: TDateAny, atInterval?: "year" | "years" | "month" | "months" | "week" | "weeks" | "day" | "days" | "hour" | "hours" | "minute" | "minutes" | "second" | "seconds" | "millisecond" | "milliseconds" | undefined) => boolean;
