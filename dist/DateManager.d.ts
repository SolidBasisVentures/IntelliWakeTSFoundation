...
export declare const DateFormatAny: (format: TDateFormat | string, date?: string | number | Date | null | undefined, timezoneDisplay?: string | undefined, timezoneSource?: string | undefined) => string | null;
export declare const DateFormat: (format: TDateFormat, date?: string | number | Date | null | undefined, timezoneDisplay?: string | undefined, timezoneSource?: string | undefined) => string | null;
